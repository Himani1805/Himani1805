...
- Full Stack Developer experienced in building responsive, user-friendly web applications.
- Skilled in **React.js, JavaScript, Node.js, Express.js, MongoDB, PostgreSQL, REST APIs, and authentication flows**.
- Built real-world projects across **CRM, healthcare, admin dashboards, AI utilities, e-commerce, and data-driven applications**.
- Focused on clean code, smooth API integration, practical problem solving, and maintainable application architecture.
...
| --- | --- | --- |
| [Prime Health](https://prime-health-one.vercel.app) | Multi-tenant hospital management workflows, dashboards, roles, and secure backend structure | React, Express.js, MongoDB, Redux Toolkit, Tailwind |
| [PowerX CRM](https://power-x-pink.vercel.app) | CRM for large lead datasets with RBAC, tracking workflows, and real-time alerts | React, PostgreSQL, Prisma, Redux, Socket.io |
| [Nomichi Trip Desk](https://nomichi-trip-desk-xi.vercel.app) | Travel enquiry and admin operations system with leads, availability, and AI WhatsApp drafts | Next.js, Supabase, PostgreSQL, Gemini API |
| [WaiverPro Compliance Agent](https://waiverpro-compliance-agent.vercel.app) | AI audit workflow comparing live app screens with PDF compliance guidelines | React, Vite, Puppeteer, AI, MongoDB |
